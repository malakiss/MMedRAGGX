...
class DPOTrainer(Trainer):
    ...
    def concatenated_multi_forward(
    ...
    def get_batch_metrics(
        ...
        (
            ...
            rejected_own_logps,
        ) = self.concatenated_multi_forward(model, batch)       
        with torch.no_grad():
            if self.ref_model is None:
                with self.accelerator.unwrap_model(self.model).disable_adapter():
                    ...
                    ) = self.concatenated_multi_forward(self.model, batch)
            else:
                (
                    reference_chosen_logps,
                    reference_rejected_logps,
                    ...
                    _,
                    reference_rejected_own_logps,
                ) = self.concatenated_multi_forward(self.ref_model, batch)
